...
public abstract class ReplicatedEventProcessorImpl implements ReplicatedEventProcessor {
  ...
  protected ReplicatedEventProcessorImpl(EventWrapper.Originator eventType, ReplicatedEventsCoordinator replicatedEventsCoordinator){
